...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-AKSClusterBGO59"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "backendterrabgo59"      # mettre le nom du compte de stockage créer dans le lab 1
